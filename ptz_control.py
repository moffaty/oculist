...
class ptzControl(object):
    ...
    def move_to_origin(self, out=True):
        ...
        self.requesta.Speed.Zoom.x = 1.0
        ret = self.ptz.AbsoluteMove(self.requesta)

    def move_to_direction(self, pan_angle, tilt_angle):
        self.requesta.Position.PanTilt.x = pan_angle
        self.requesta.Position.PanTilt.y = tilt_angle
        self.requesta.Position.Zoom.x = 0.0  # Adjust zoom as needed
        self.requesta.Speed.PanTilt.x = 1.0  # Set speed (adjust as needed)
        self.requesta.Speed.PanTilt.y = 1.0
        self.requesta.Speed.Zoom.x = 1.0
        ret = self.ptz.AbsoluteMove(self.requesta)
    ...
    def get_current_orientation(self):
        pan_tilt = self.requesta.Position.PanTilt
